...
Ram_top		= $7600			; end of user RAM+1 (set as needed, should be page aligned)
...
LAB_vec:
	.word	read_char		; check for break (Ctrl+C)
	.word	read_char		; byte in from keyboard
	.word	print_char		; byte out to screen
	.word	mh_load			; load vector for EhBASIC
	.word	mh_save			; save vector for EhBASIC
...
; new page 2 initialization, copy block to ccflag on
...
LAB_BMSG	.byte	$07, "Break",$00
LAB_EMSG	.byte	$07, " Error",$00
